...
entity_names = [
    ...
    "ENTITY_TOON_TV_MUSHROOM_PROJECTILE",
    "ENTITY_TOON_TV_LIZARD",
    "ENTITY_TOON_TV_HAPPY_FACE",
    "ENTITY_TOON_TV_VANISHING_BLOCK",
    "ENTITY_TOON_TV_MOVING_BLOCK",
    "ENTITY_TOON_TV_MOVING_LOG",
    "ENTITY_TOON_TV_STATIONARY_LOG",
    "ENTITY_TOON_TV_FLOWER_HAMMER",
    ...
    "ENTITY_CHANNEL_Z_UNUSED_PLATFORM_1",
    "ENTITY_CHANNEL_Z_UNUSED_PLATFORM_2",
    "ENTITY_CHANNEL_Z_REZ_FOLLOWING_FIRE",
    "ENTITY_CHANNEL_Z_GUN_PROJECTILE_EXPLOSION",
    "ENTITY_FINAL_BATTLE_BUTTON_PROJECTILE",
    "ENTITY_CHANNEL_Z_FINAL_BATTLE_BUTTON",
    "ENTITY_CHANNEL_Z_REZ_PORTAL",
    "ENTITY_UNK_8E",
