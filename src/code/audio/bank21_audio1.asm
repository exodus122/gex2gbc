...
; touch rNR52, so the APU is left however the caller had it
    ...
    ld   A, L                                          ;; 21:4003 $7d
    ld   [wDFAE_Audio_TrackTablesPtrLo], A                                    ;; 21:4004 $ea $ae $df
    ld   A, H                                          ;; 21:4007 $7c
    ld   [wDFAF_Audio_TrackTablesPtrHi], A                                    ;; 21:4008 $ea $af $df
    xor  A, A                                          ;; 21:400b $af
    ...
    ld   [wDFB9_Audio_MusicNoteTimerCh1], A                                    ;; 21:4017 $ea $b9 $df
    ld   [wDFBA_Audio_MusicNoteTimerCh2], A                                    ;; 21:401a $ea $ba $df
    ld   [wDFBB_Audio_MusicNoteTimerCh3], A                                    ;; 21:401d $ea $bb $df
    ld   [wDFBC_Audio_MusicNoteTimerCh4], A                                    ;; 21:4020 $ea $bc $df
    ld   [wDFCF_Audio_SfxChannelsActive], A                                    ;; 21:4023 $ea $cf $df
    ld   [wDFCB_Audio_SfxNoteTimerCh1], A                                    ;; 21:4026 $ea $cb $df
    ld   [wDFCC_Audio_SfxNoteTimerCh2], A                                    ;; 21:4029 $ea $cc $df
    ld   [wDFCD_Audio_SfxNoteTimerCh3], A                                    ;; 21:402c $ea $cd $df
    ld   [wDFCE_Audio_SfxNoteTimerCh4], A                                    ;; 21:402f $ea $ce $df
...
.jr_21_407f:
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 21:407f $fa $ae $df
    ld   E, A                                          ;; 21:4082 $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 21:4083 $fa $af $df
    ld   D, A                                          ;; 21:4086 $57
    ld   A, [DE]                                       ;; 21:4087 $1a
    add  A, E                                          ;; 21:4088 $83
    ld   L, A                                          ;; 21:4089 $6f
...
; track table block, immediately after the word that locates the sfx list
    ...
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 21:409a $fa $ae $df
    ld   E, A                                          ;; 21:409d $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 21:409e $fa $af $df
    ld   D, A                                          ;; 21:40a1 $57
    inc  DE                                            ;; 21:40a2 $13
    inc  DE                                            ;; 21:40a3 $13
...
; value is that channel's initial countdown
    ...
    ld   E, L                                          ;; 21:40bc $5d
    ld   A, [DE]                                       ;; 21:40bd $1a
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 21:40be $ea $fe $df
    ld   L, A                                          ;; 21:40c1 $6f
    xor  A, A                                          ;; 21:40c2 $af
    scf                                                ;; 21:40c3 $37
.jr_21_40c4:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 21:40de $01 $cb $df
...
.jr_21_40e3:
    ...
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 21:40ed $01 $b9 $df
.jr_21_40f0:
    ld   A, [DE]                                       ;; 21:40f0 $1a
    dec  A                                             ;; 21:40f1 $3d
    sla  A                                             ;; 21:40f2 $cb $27
...
; why they live in WRAM rather than in registers
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 21:410c $01 $b9 $df
...
.jp_21_4121:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 21:4133 $ea $fe $df
...
.jr_21_4139:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 21:4152 $01 $cb $df
...
.jp_21_4167:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 21:4179 $ea $fe $df
...
.jr_21_41ae:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 21:41da $fa $fe $df
    sla  A                                             ;; 21:41dd $cb $27
    sla  A                                             ;; 21:41df $cb $27
    add  A, E                                          ;; 21:41e1 $83
    ld   E, A                                          ;; 21:41e2 $5f
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 21:41e3 $fa $fe $df
    add  A, E                                          ;; 21:41e6 $83
    ld   E, A                                          ;; 21:41e7 $5f
    ld   HL, data_21_439e_ChannelSaveRegs                              ;; 21:41e8 $21 $9e $43
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 21:41eb $fa $fe $df
    sla  A                                             ;; 21:41ee $cb $27
    ld   C, A                                          ;; 21:41f0 $4f
    sla  A                                             ;; 21:41f1 $cb $27
    sla  A                                             ;; 21:41f3 $cb $27
...
.jr_21_421b:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 21:421e $fa $fe $df
    sla  A                                             ;; 21:4221 $cb $27
    add  A, L                                          ;; 21:4223 $85
    ld   L, A                                          ;; 21:4224 $6f
...
.jr_21_4307:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 21:4313 $fa $fe $df
    sla  A                                             ;; 21:4316 $cb $27
    add  A, E                                          ;; 21:4318 $83
    ld   E, A                                          ;; 21:4319 $5f
...
.sfx_list:
    ...
    dw   audio_21_7313_Sfx_GexPowerupActive - @    ; SFX_GEX_POWERUP_ACTIVE (sfx $14)
    dw   audio_21_7341_Sfx_GexPowerupExpired - @      ; SFX_GEX_POWERUP_EXPIRED (sfx $15)
    ...
    dw   audio_21_750b_Sfx_EnemyJump - @                  ; SFX_ENEMY_JUMP (sfx $24)
    ...
    dw   audio_21_75af_Sfx_AltEnemyJump - @               ; SFX_ALT_ENEMY_JUMP (sfx $29)
    dw   audio_21_75d7_Sfx_GexPoweredJump - @             ; SFX_GEX_POWERED_JUMP (sfx $2A)
    ...
    dw   audio_21_77b9_Sfx_Explosion - @                  ; SFX_EXPLOSION (sfx $37)
    dw   audio_21_7811_Sfx_RezHurt - @                    ; SFX_REZ_HURT (sfx $38)
...
audio_21_44fe_Music_CircuitCentral_Ch1:
    INCLUDE "data/audio/music/music_circuit_central_ch1.asm"   ; MUSIC_CIRCUIT_CENTRAL ch1
audio_21_4744_Music_CircuitCentral_Ch2:
    INCLUDE "data/audio/music/music_circuit_central_ch2.asm"   ; MUSIC_CIRCUIT_CENTRAL ch2
audio_21_496a_Music_CircuitCentral_Ch3:
    INCLUDE "data/audio/music/music_circuit_central_ch3.asm"   ; MUSIC_CIRCUIT_CENTRAL ch3
audio_21_49e9_Music_CircuitCentral_Ch4:
    INCLUDE "data/audio/music/music_circuit_central_ch4.asm"   ; MUSIC_CIRCUIT_CENTRAL ch4
audio_21_49ff_Music_KungFuTheater_Ch1:
    INCLUDE "data/audio/music/music_kung_fu_theater_ch1.asm"   ; MUSIC_KUNG_FU_THEATER ch1
audio_21_4c93_Music_KungFuTheater_Ch2:
    INCLUDE "data/audio/music/music_kung_fu_theater_ch2.asm"   ; MUSIC_KUNG_FU_THEATER ch2
audio_21_4f11_Music_KungFuTheater_Ch3:
    INCLUDE "data/audio/music/music_kung_fu_theater_ch3.asm"   ; MUSIC_KUNG_FU_THEATER ch3
audio_21_53b0_Music_KungFuTheater_Ch4:
    INCLUDE "data/audio/music/music_kung_fu_theater_ch4.asm"   ; MUSIC_KUNG_FU_THEATER ch4
audio_21_5852_Music_PrehistoryChannel_Ch1:
    INCLUDE "data/audio/music/music_prehistory_channel_ch1.asm"; MUSIC_PREHISTORY_CHANNEL ch1
audio_21_5f5a_Music_PrehistoryChannel_Ch2:
    INCLUDE "data/audio/music/music_prehistory_channel_ch2.asm"; MUSIC_PREHISTORY_CHANNEL ch2
audio_21_62d8_Music_PrehistoryChannel_Ch3:
    INCLUDE "data/audio/music/music_prehistory_channel_ch3.asm"; MUSIC_PREHISTORY_CHANNEL ch3
audio_21_649b_Music_PrehistoryChannel_Ch4:
    INCLUDE "data/audio/music/music_prehistory_channel_ch4.asm"; MUSIC_PREHISTORY_CHANNEL ch4
