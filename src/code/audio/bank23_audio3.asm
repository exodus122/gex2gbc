...
; touch rNR52, so the APU is left however the caller had it
    ...
    ld   A, L                                          ;; 23:4003 $7d
    ld   [wDFAE_Audio_TrackTablesPtrLo], A                                    ;; 23:4004 $ea $ae $df
    ld   A, H                                          ;; 23:4007 $7c
    ld   [wDFAF_Audio_TrackTablesPtrHi], A                                    ;; 23:4008 $ea $af $df
    xor  A, A                                          ;; 23:400b $af
    ...
    ld   [wDFB9_Audio_MusicNoteTimerCh1], A                                    ;; 23:4017 $ea $b9 $df
    ld   [wDFBA_Audio_MusicNoteTimerCh2], A                                    ;; 23:401a $ea $ba $df
    ld   [wDFBB_Audio_MusicNoteTimerCh3], A                                    ;; 23:401d $ea $bb $df
    ld   [wDFBC_Audio_MusicNoteTimerCh4], A                                    ;; 23:4020 $ea $bc $df
    ld   [wDFCF_Audio_SfxChannelsActive], A                                    ;; 23:4023 $ea $cf $df
    ld   [wDFCB_Audio_SfxNoteTimerCh1], A                                    ;; 23:4026 $ea $cb $df
    ld   [wDFCC_Audio_SfxNoteTimerCh2], A                                    ;; 23:4029 $ea $cc $df
    ld   [wDFCD_Audio_SfxNoteTimerCh3], A                                    ;; 23:402c $ea $cd $df
    ld   [wDFCE_Audio_SfxNoteTimerCh4], A                                    ;; 23:402f $ea $ce $df
...
.jr_23_407f:
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 23:407f $fa $ae $df
    ld   E, A                                          ;; 23:4082 $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 23:4083 $fa $af $df
    ld   D, A                                          ;; 23:4086 $57
    ld   A, [DE]                                       ;; 23:4087 $1a
    add  A, E                                          ;; 23:4088 $83
    ld   L, A                                          ;; 23:4089 $6f
...
; track table block, immediately after the word that locates the sfx list
    ...
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 23:409a $fa $ae $df
    ld   E, A                                          ;; 23:409d $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 23:409e $fa $af $df
    ld   D, A                                          ;; 23:40a1 $57
    inc  DE                                            ;; 23:40a2 $13
    inc  DE                                            ;; 23:40a3 $13
...
; value is that channel's initial countdown
    ...
    ld   E, L                                          ;; 23:40bc $5d
    ld   A, [DE]                                       ;; 23:40bd $1a
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 23:40be $ea $fe $df
    ld   L, A                                          ;; 23:40c1 $6f
    xor  A, A                                          ;; 23:40c2 $af
    scf                                                ;; 23:40c3 $37
.jr_23_40c4:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 23:40de $01 $cb $df
...
.jr_23_40e3:
    ...
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 23:40ed $01 $b9 $df
.jr_23_40f0:
    ld   A, [DE]                                       ;; 23:40f0 $1a
    dec  A                                             ;; 23:40f1 $3d
    sla  A                                             ;; 23:40f2 $cb $27
...
; why they live in WRAM rather than in registers
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 23:410c $01 $b9 $df
...
.jp_23_4121:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 23:4133 $ea $fe $df
...
.jr_23_4139:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 23:4152 $01 $cb $df
...
.jp_23_4167:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 23:4179 $ea $fe $df
...
.jr_23_41ae:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 23:41da $fa $fe $df
    sla  A                                             ;; 23:41dd $cb $27
    sla  A                                             ;; 23:41df $cb $27
    add  A, E                                          ;; 23:41e1 $83
    ld   E, A                                          ;; 23:41e2 $5f
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 23:41e3 $fa $fe $df
    add  A, E                                          ;; 23:41e6 $83
    ld   E, A                                          ;; 23:41e7 $5f
    ld   HL, data_23_439e_ChannelSaveRegs                              ;; 23:41e8 $21 $9e $43
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 23:41eb $fa $fe $df
    sla  A                                             ;; 23:41ee $cb $27
    ld   C, A                                          ;; 23:41f0 $4f
    sla  A                                             ;; 23:41f1 $cb $27
    sla  A                                             ;; 23:41f3 $cb $27
...
.jr_23_421b:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 23:421e $fa $fe $df
    sla  A                                             ;; 23:4221 $cb $27
    add  A, L                                          ;; 23:4223 $85
    ld   L, A                                          ;; 23:4224 $6f
...
.jr_23_4307:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 23:4313 $fa $fe $df
    sla  A                                             ;; 23:4316 $cb $27
    add  A, E                                          ;; 23:4318 $83
    ld   E, A                                          ;; 23:4319 $5f
...
audio_23_44f6_Music_MediaDimension_Ch1:
    INCLUDE "data/audio/music/music_media_dimension_ch1.asm"   ; MUSIC_MEDIA_DIMENSION ch1
audio_23_47e2_Music_MediaDimension_Ch2:
    INCLUDE "data/audio/music/music_media_dimension_ch2.asm"   ; MUSIC_MEDIA_DIMENSION ch2
audio_23_4a1e_Music_MediaDimension_Ch3:
    INCLUDE "data/audio/music/music_media_dimension_ch3.asm"   ; MUSIC_MEDIA_DIMENSION ch3
audio_23_4e89_Music_MediaDimension_Ch4:
    INCLUDE "data/audio/music/music_media_dimension_ch4.asm"   ; MUSIC_MEDIA_DIMENSION ch4
audio_23_54d3_Music_ToonTv_Ch1:
    INCLUDE "data/audio/music/music_toon_tv_ch1.asm"           ; MUSIC_TOON_TV ch1
audio_23_5ae7_Music_ToonTv_Ch2:
    INCLUDE "data/audio/music/music_toon_tv_ch2.asm"           ; MUSIC_TOON_TV ch2
audio_23_6113_Music_ToonTv_Ch3:
    INCLUDE "data/audio/music/music_toon_tv_ch3.asm"           ; MUSIC_TOON_TV ch3
audio_23_632a_Music_ToonTv_Ch4:
    INCLUDE "data/audio/music/music_toon_tv_ch4.asm"           ; MUSIC_TOON_TV ch4
