...
;   timers           wDFB9_Audio_MusicNoteTimerCh1 ...      wDFCB_Audio_SfxNoteTimerCh1 ...
...
; and an arpeggio, and songs are built from reusable patterns instead of one flat stream
; per channel. The AUDIO_* constants and the Audio_* routine names line up where the two
; drivers do the same job
; ==================================================================

SECTION "bank24", ROMX[$4000], BANK[$24]

call_24_4000_Audio_Init:
; Boot-time reset. Points wDFAE_Audio_TrackTablesPtrLo at this bank's track tables,
...
; touch rNR52, so the APU is left however the caller had it
    ...
    ld   A, L                                          ;; 24:4003 $7d
    ld   [wDFAE_Audio_TrackTablesPtrLo], A                                    ;; 24:4004 $ea $ae $df
    ld   A, H                                          ;; 24:4007 $7c
    ld   [wDFAF_Audio_TrackTablesPtrHi], A                                    ;; 24:4008 $ea $af $df
    xor  A, A                                          ;; 24:400b $af
    ...
    ld   [wDFB9_Audio_MusicNoteTimerCh1], A                                    ;; 24:4017 $ea $b9 $df
    ld   [wDFBA_Audio_MusicNoteTimerCh2], A                                    ;; 24:401a $ea $ba $df
    ld   [wDFBB_Audio_MusicNoteTimerCh3], A                                    ;; 24:401d $ea $bb $df
    ld   [wDFBC_Audio_MusicNoteTimerCh4], A                                    ;; 24:4020 $ea $bc $df
    ld   [wDFCF_Audio_SfxChannelsActive], A                                    ;; 24:4023 $ea $cf $df
    ld   [wDFCB_Audio_SfxNoteTimerCh1], A                                    ;; 24:4026 $ea $cb $df
    ld   [wDFCC_Audio_SfxNoteTimerCh2], A                                    ;; 24:4029 $ea $cc $df
    ld   [wDFCD_Audio_SfxNoteTimerCh3], A                                    ;; 24:402c $ea $cd $df
    ld   [wDFCE_Audio_SfxNoteTimerCh4], A                                    ;; 24:402f $ea $ce $df
...
.jr_24_407f:
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 24:407f $fa $ae $df
    ld   E, A                                          ;; 24:4082 $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 24:4083 $fa $af $df
    ld   D, A                                          ;; 24:4086 $57
    ld   A, [DE]                                       ;; 24:4087 $1a
    add  A, E                                          ;; 24:4088 $83
    ld   L, A                                          ;; 24:4089 $6f
...
; track table block, immediately after the word that locates the sfx list
    ...
    ld   A, [wDFAE_Audio_TrackTablesPtrLo]                                    ;; 24:409a $fa $ae $df
    ld   E, A                                          ;; 24:409d $5f
    ld   A, [wDFAF_Audio_TrackTablesPtrHi]                                    ;; 24:409e $fa $af $df
    ld   D, A                                          ;; 24:40a1 $57
    inc  DE                                            ;; 24:40a2 $13
    inc  DE                                            ;; 24:40a3 $13
...
; value is that channel's initial countdown
    ...
    ld   E, L                                          ;; 24:40bc $5d
    ld   A, [DE]                                       ;; 24:40bd $1a
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 24:40be $ea $fe $df
    ld   L, A                                          ;; 24:40c1 $6f
    xor  A, A                                          ;; 24:40c2 $af
    scf                                                ;; 24:40c3 $37
.jr_24_40c4:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 24:40de $01 $cb $df
...
.jr_24_40e3:
    ...
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 24:40ed $01 $b9 $df
.jr_24_40f0:
    ld   A, [DE]                                       ;; 24:40f0 $1a
    dec  A                                             ;; 24:40f1 $3d
    sla  A                                             ;; 24:40f2 $cb $27
...
; why they live in WRAM rather than in registers
    ld   BC, wDFB9_Audio_MusicNoteTimerCh1                                     ;; 24:410c $01 $b9 $df
...
.jp_24_4121:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 24:4133 $ea $fe $df
...
.jr_24_4139:
    ...
    ld   BC, wDFCB_Audio_SfxNoteTimerCh1                                     ;; 24:4152 $01 $cb $df
...
.jp_24_4167:
    ...
    ld   [wDFFE_Audio_SequenceChannelIndex], A                                    ;; 24:4179 $ea $fe $df
...
.jr_24_41ae:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 24:41da $fa $fe $df
    sla  A                                             ;; 24:41dd $cb $27
    sla  A                                             ;; 24:41df $cb $27
    add  A, E                                          ;; 24:41e1 $83
    ld   E, A                                          ;; 24:41e2 $5f
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 24:41e3 $fa $fe $df
    add  A, E                                          ;; 24:41e6 $83
    ld   E, A                                          ;; 24:41e7 $5f
    ld   HL, data_24_439e_ChannelSaveRegs                              ;; 24:41e8 $21 $9e $43
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 24:41eb $fa $fe $df
    sla  A                                             ;; 24:41ee $cb $27
    ld   C, A                                          ;; 24:41f0 $4f
    sla  A                                             ;; 24:41f1 $cb $27
    sla  A                                             ;; 24:41f3 $cb $27
...
.jr_24_421b:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 24:421e $fa $fe $df
    sla  A                                             ;; 24:4221 $cb $27
    add  A, L                                          ;; 24:4223 $85
    ld   L, A                                          ;; 24:4224 $6f
...
.jr_24_4307:
    ...
    ld   A, [wDFFE_Audio_SequenceChannelIndex]                                    ;; 24:4313 $fa $fe $df
    sla  A                                             ;; 24:4316 $cb $27
    add  A, E                                          ;; 24:4318 $83
    ld   E, A                                          ;; 24:4319 $5f
...
;
; Bank $24 puts all 66 of its entries in the music list and leaves the sfx list
; empty - .sfx_list below marks where it would start, which is also where the
; track data begins. Nothing reaches any of it
    dw   .sfx_list - @                ; where the sfx half starts

.music_list:
    dw   audio_24_44e6_Unused_00 - @    ; entry $00 - unreachable, nothing selects bank $24
    dw   audio_24_4500_Unused_01 - @    ; entry $01 - unreachable, nothing selects bank $24
    dw   audio_24_4524_Unused_02 - @    ; entry $02 - unreachable, nothing selects bank $24
    dw   audio_24_4544_Unused_03 - @    ; entry $03 - unreachable, nothing selects bank $24
    dw   audio_24_458c_Unused_04 - @    ; entry $04 - unreachable, nothing selects bank $24
    dw   audio_24_45fa_Unused_05 - @    ; entry $05 - unreachable, nothing selects bank $24
    dw   audio_24_460e_Unused_06 - @    ; entry $06 - unreachable, nothing selects bank $24
    dw   audio_24_4650_Unused_07 - @    ; entry $07 - unreachable, nothing selects bank $24
    dw   audio_24_4664_Unused_08 - @    ; entry $08 - unreachable, nothing selects bank $24
    dw   audio_24_4678_Unused_09 - @    ; entry $09 - unreachable, nothing selects bank $24
    dw   audio_24_4694_Unused_0A - @    ; entry $0A - unreachable, nothing selects bank $24
    dw   audio_24_46ae_Unused_0B - @    ; entry $0B - unreachable, nothing selects bank $24
    dw   audio_24_46ce_Unused_0C - @    ; entry $0C - unreachable, nothing selects bank $24
    dw   audio_24_46fe_Unused_0D - @    ; entry $0D - unreachable, nothing selects bank $24
    dw   audio_24_4762_Unused_0E - @    ; entry $0E - unreachable, nothing selects bank $24
    dw   audio_24_47ac_Unused_0F - @    ; entry $0F - unreachable, nothing selects bank $24
    dw   audio_24_480a_Unused_10 - @    ; entry $10 - unreachable, nothing selects bank $24
    dw   audio_24_485c_Unused_11 - @    ; entry $11 - unreachable, nothing selects bank $24
    dw   audio_24_4a10_Unused_12 - @    ; entry $12 - unreachable, nothing selects bank $24
    dw   audio_24_4a2a_Unused_13 - @    ; entry $13 - unreachable, nothing selects bank $24
    dw   audio_24_4a8c_Unused_14 - @    ; entry $14 - unreachable, nothing selects bank $24
    dw   audio_24_4ac0_Unused_15 - @    ; entry $15 - unreachable, nothing selects bank $24
    dw   audio_24_4af4_Unused_16 - @    ; entry $16 - unreachable, nothing selects bank $24
    dw   audio_24_4b0e_Unused_17 - @    ; entry $17 - unreachable, nothing selects bank $24
    dw   audio_24_4b2c_Unused_18 - @    ; entry $18 - unreachable, nothing selects bank $24
    dw   audio_24_4b44_Unused_19 - @    ; entry $19 - unreachable, nothing selects bank $24
    dw   audio_24_4b58_Unused_1A - @    ; entry $1A - unreachable, nothing selects bank $24
    dw   audio_24_4b74_Unused_1B - @    ; entry $1B - unreachable, nothing selects bank $24
    dw   audio_24_4b90_Unused_1C - @    ; entry $1C - unreachable, nothing selects bank $24
    dw   audio_24_4ba0_Unused_1D - @    ; entry $1D - unreachable, nothing selects bank $24
    dw   audio_24_4bbc_Unused_1E - @    ; entry $1E - unreachable, nothing selects bank $24
    dw   audio_24_4c1c_Unused_1F - @    ; entry $1F - unreachable, nothing selects bank $24
    dw   audio_24_4c36_Unused_20 - @    ; entry $20 - unreachable, nothing selects bank $24
    dw   audio_24_4c80_Unused_21 - @    ; entry $21 - unreachable, nothing selects bank $24
    dw   audio_24_4c9a_Unused_22 - @    ; entry $22 - unreachable, nothing selects bank $24
    dw   audio_24_4ce4_Unused_23 - @    ; entry $23 - unreachable, nothing selects bank $24
    dw   audio_24_4d2e_Unused_24 - @    ; entry $24 - unreachable, nothing selects bank $24
    dw   audio_24_4d4c_Unused_25 - @    ; entry $25 - unreachable, nothing selects bank $24
    dw   audio_24_4d5c_Unused_26 - @    ; entry $26 - unreachable, nothing selects bank $24
    dw   audio_24_4d8a_Unused_27 - @    ; entry $27 - unreachable, nothing selects bank $24
    dw   audio_24_4df2_Unused_28 - @    ; entry $28 - unreachable, nothing selects bank $24
    dw   audio_24_4e16_Unused_29 - @    ; entry $29 - unreachable, nothing selects bank $24
    dw   audio_24_4e60_Unused_2A - @    ; entry $2A - unreachable, nothing selects bank $24
    dw   audio_24_4e7a_Unused_2B - @    ; entry $2B - unreachable, nothing selects bank $24
    dw   audio_24_4ec0_Unused_2C - @    ; entry $2C - unreachable, nothing selects bank $24
    dw   audio_24_4eee_Unused_2D - @    ; entry $2D - unreachable, nothing selects bank $24
    dw   audio_24_4f46_Unused_2E - @    ; entry $2E - unreachable, nothing selects bank $24
    dw   audio_24_4f5e_Unused_2F - @    ; entry $2F - unreachable, nothing selects bank $24
    dw   audio_24_4f78_Unused_30 - @    ; entry $30 - unreachable, nothing selects bank $24
    dw   audio_24_4f94_Unused_31 - @    ; entry $31 - unreachable, nothing selects bank $24
    dw   audio_24_4fae_Unused_32 - @    ; entry $32 - unreachable, nothing selects bank $24
    dw   audio_24_4fbc_Unused_33 - @    ; entry $33 - unreachable, nothing selects bank $24
    dw   audio_24_4fdc_Unused_34 - @    ; entry $34 - unreachable, nothing selects bank $24
    dw   audio_24_500c_Unused_35 - @    ; entry $35 - unreachable, nothing selects bank $24
    dw   audio_24_5026_Unused_36 - @    ; entry $36 - unreachable, nothing selects bank $24
    dw   audio_24_5044_Unused_37 - @    ; entry $37 - unreachable, nothing selects bank $24
    dw   audio_24_5078_Unused_38 - @    ; entry $38 - unreachable, nothing selects bank $24
    dw   audio_24_5098_Unused_39 - @    ; entry $39 - unreachable, nothing selects bank $24
    dw   audio_24_50b2_Unused_3A - @    ; entry $3A - unreachable, nothing selects bank $24
    dw   audio_24_50cc_Unused_3B - @    ; entry $3B - unreachable, nothing selects bank $24
    dw   audio_24_50e6_Unused_3C - @    ; entry $3C - unreachable, nothing selects bank $24
    dw   audio_24_5102_Unused_3D - @    ; entry $3D - unreachable, nothing selects bank $24
    dw   audio_24_511e_Unused_3E - @    ; entry $3E - unreachable, nothing selects bank $24
    dw   audio_24_5122_Unused_3F - @    ; entry $3F - unreachable, nothing selects bank $24
    dw   audio_24_5126_Unused_40 - @    ; entry $40 - unreachable, nothing selects bank $24
    dw   audio_24_512a_Unused_41 - @    ; entry $41 - unreachable, nothing selects bank $24

.sfx_list:

audio_24_44e6_Unused_00:
    INCLUDE "data/audio/unused/unused_24_00.asm"               ; entry $00 - unreachable, nothing selects bank $24
audio_24_4500_Unused_01:
    INCLUDE "data/audio/unused/unused_24_01.asm"               ; entry $01 - unreachable, nothing selects bank $24
audio_24_4524_Unused_02:
    INCLUDE "data/audio/unused/unused_24_02.asm"               ; entry $02 - unreachable, nothing selects bank $24
audio_24_4544_Unused_03:
    INCLUDE "data/audio/unused/unused_24_03.asm"               ; entry $03 - unreachable, nothing selects bank $24
audio_24_458c_Unused_04:
    INCLUDE "data/audio/unused/unused_24_04.asm"               ; entry $04 - unreachable, nothing selects bank $24
audio_24_45fa_Unused_05:
    INCLUDE "data/audio/unused/unused_24_05.asm"               ; entry $05 - unreachable, nothing selects bank $24
audio_24_460e_Unused_06:
    INCLUDE "data/audio/unused/unused_24_06.asm"               ; entry $06 - unreachable, nothing selects bank $24
audio_24_4650_Unused_07:
    INCLUDE "data/audio/unused/unused_24_05.asm"               ; entry $07 - unreachable, nothing selects bank $24
audio_24_4664_Unused_08:
    INCLUDE "data/audio/unused/unused_24_05.asm"               ; entry $08 - unreachable, nothing selects bank $24
audio_24_4678_Unused_09:
    INCLUDE "data/audio/unused/unused_24_09.asm"               ; entry $09 - unreachable, nothing selects bank $24
audio_24_4694_Unused_0A:
    INCLUDE "data/audio/unused/unused_24_0a.asm"               ; entry $0A - unreachable, nothing selects bank $24
audio_24_46ae_Unused_0B:
    INCLUDE "data/audio/unused/unused_24_02.asm"               ; entry $0B - unreachable, nothing selects bank $24
audio_24_46ce_Unused_0C:
    INCLUDE "data/audio/unused/unused_24_0c.asm"               ; entry $0C - unreachable, nothing selects bank $24
audio_24_46fe_Unused_0D:
    INCLUDE "data/audio/unused/unused_24_0d.asm"               ; entry $0D - unreachable, nothing selects bank $24
audio_24_4762_Unused_0E:
    INCLUDE "data/audio/unused/unused_24_0e.asm"               ; entry $0E - unreachable, nothing selects bank $24
audio_24_47ac_Unused_0F:
    INCLUDE "data/audio/unused/unused_24_0f.asm"               ; entry $0F - unreachable, nothing selects bank $24
audio_24_480a_Unused_10:
    INCLUDE "data/audio/unused/unused_24_10.asm"               ; entry $10 - unreachable, nothing selects bank $24
audio_24_485c_Unused_11:
    INCLUDE "data/audio/unused/unused_24_11.asm"               ; entry $11 - unreachable, nothing selects bank $24
audio_24_4a10_Unused_12:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $12 - unreachable, nothing selects bank $24
audio_24_4a2a_Unused_13:
    INCLUDE "data/audio/unused/unused_24_13.asm"               ; entry $13 - unreachable, nothing selects bank $24
audio_24_4a8c_Unused_14:
    INCLUDE "data/audio/unused/unused_24_14.asm"               ; entry $14 - unreachable, nothing selects bank $24
audio_24_4ac0_Unused_15:
    INCLUDE "data/audio/unused/unused_24_15.asm"               ; entry $15 - unreachable, nothing selects bank $24
audio_24_4af4_Unused_16:
    INCLUDE "data/audio/unused/unused_24_16.asm"               ; entry $16 - unreachable, nothing selects bank $24
audio_24_4b0e_Unused_17:
    INCLUDE "data/audio/unused/unused_24_17.asm"               ; entry $17 - unreachable, nothing selects bank $24
audio_24_4b2c_Unused_18:
    INCLUDE "data/audio/unused/unused_24_18.asm"               ; entry $18 - unreachable, nothing selects bank $24
audio_24_4b44_Unused_19:
    INCLUDE "data/audio/unused/unused_24_05.asm"               ; entry $19 - unreachable, nothing selects bank $24
audio_24_4b58_Unused_1A:
    INCLUDE "data/audio/unused/unused_24_1a.asm"               ; entry $1A - unreachable, nothing selects bank $24
audio_24_4b74_Unused_1B:
    INCLUDE "data/audio/unused/unused_24_1b.asm"               ; entry $1B - unreachable, nothing selects bank $24
audio_24_4b90_Unused_1C:
    INCLUDE "data/audio/unused/unused_24_1c.asm"               ; entry $1C - unreachable, nothing selects bank $24
audio_24_4ba0_Unused_1D:
    INCLUDE "data/audio/unused/unused_24_1a.asm"               ; entry $1D - unreachable, nothing selects bank $24
audio_24_4bbc_Unused_1E:
    INCLUDE "data/audio/unused/unused_24_1e.asm"               ; entry $1E - unreachable, nothing selects bank $24
audio_24_4c1c_Unused_1F:
    INCLUDE "data/audio/unused/unused_24_1f.asm"               ; entry $1F - unreachable, nothing selects bank $24
audio_24_4c36_Unused_20:
    INCLUDE "data/audio/unused/unused_24_0e.asm"               ; entry $20 - unreachable, nothing selects bank $24
audio_24_4c80_Unused_21:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $21 - unreachable, nothing selects bank $24
audio_24_4c9a_Unused_22:
    INCLUDE "data/audio/unused/unused_24_0e.asm"               ; entry $22 - unreachable, nothing selects bank $24
audio_24_4ce4_Unused_23:
    INCLUDE "data/audio/unused/unused_24_0e.asm"               ; entry $23 - unreachable, nothing selects bank $24
audio_24_4d2e_Unused_24:
    INCLUDE "data/audio/unused/unused_24_24.asm"               ; entry $24 - unreachable, nothing selects bank $24
audio_24_4d4c_Unused_25:
    INCLUDE "data/audio/unused/unused_24_25.asm"               ; entry $25 - unreachable, nothing selects bank $24
audio_24_4d5c_Unused_26:
    INCLUDE "data/audio/unused/unused_24_26.asm"               ; entry $26 - unreachable, nothing selects bank $24
audio_24_4d8a_Unused_27:
    INCLUDE "data/audio/unused/unused_24_27.asm"               ; entry $27 - unreachable, nothing selects bank $24
audio_24_4df2_Unused_28:
    INCLUDE "data/audio/unused/unused_24_28.asm"               ; entry $28 - unreachable, nothing selects bank $24
audio_24_4e16_Unused_29:
    INCLUDE "data/audio/unused/unused_24_0e.asm"               ; entry $29 - unreachable, nothing selects bank $24
audio_24_4e60_Unused_2A:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $2A - unreachable, nothing selects bank $24
audio_24_4e7a_Unused_2B:
    INCLUDE "data/audio/unused/unused_24_2b.asm"               ; entry $2B - unreachable, nothing selects bank $24
audio_24_4ec0_Unused_2C:
    INCLUDE "data/audio/unused/unused_24_26.asm"               ; entry $2C - unreachable, nothing selects bank $24
audio_24_4eee_Unused_2D:
    INCLUDE "data/audio/unused/unused_24_2d.asm"               ; entry $2D - unreachable, nothing selects bank $24
audio_24_4f46_Unused_2E:
    INCLUDE "data/audio/unused/unused_24_2e.asm"               ; entry $2E - unreachable, nothing selects bank $24
audio_24_4f5e_Unused_2F:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $2F - unreachable, nothing selects bank $24
audio_24_4f78_Unused_30:
    INCLUDE "data/audio/unused/unused_24_1a.asm"               ; entry $30 - unreachable, nothing selects bank $24
audio_24_4f94_Unused_31:
    INCLUDE "data/audio/unused/unused_24_31.asm"               ; entry $31 - unreachable, nothing selects bank $24
audio_24_4fae_Unused_32:
    INCLUDE "data/audio/unused/unused_24_32.asm"               ; entry $32 - unreachable, nothing selects bank $24
audio_24_4fbc_Unused_33:
    INCLUDE "data/audio/unused/unused_24_33.asm"               ; entry $33 - unreachable, nothing selects bank $24
audio_24_4fdc_Unused_34:
    INCLUDE "data/audio/unused/unused_24_0c.asm"               ; entry $34 - unreachable, nothing selects bank $24
audio_24_500c_Unused_35:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $35 - unreachable, nothing selects bank $24
audio_24_5026_Unused_36:
    INCLUDE "data/audio/unused/unused_24_36.asm"               ; entry $36 - unreachable, nothing selects bank $24
audio_24_5044_Unused_37:
    INCLUDE "data/audio/unused/unused_24_37.asm"               ; entry $37 - unreachable, nothing selects bank $24
audio_24_5078_Unused_38:
    INCLUDE "data/audio/unused/unused_24_33.asm"               ; entry $38 - unreachable, nothing selects bank $24
audio_24_5098_Unused_39:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $39 - unreachable, nothing selects bank $24
audio_24_50b2_Unused_3A:
    INCLUDE "data/audio/unused/unused_24_1f.asm"               ; entry $3A - unreachable, nothing selects bank $24
audio_24_50cc_Unused_3B:
    INCLUDE "data/audio/unused/unused_24_12.asm"               ; entry $3B - unreachable, nothing selects bank $24
audio_24_50e6_Unused_3C:
    INCLUDE "data/audio/unused/unused_24_1a.asm"               ; entry $3C - unreachable, nothing selects bank $24
audio_24_5102_Unused_3D:
    INCLUDE "data/audio/unused/unused_24_3d.asm"               ; entry $3D - unreachable, nothing selects bank $24
audio_24_511e_Unused_3E:
    INCLUDE "data/audio/unused/unused_24_3e.asm"               ; entry $3E - unreachable, nothing selects bank $24
audio_24_5122_Unused_3F:
    INCLUDE "data/audio/unused/unused_24_3f.asm"               ; entry $3F - unreachable, nothing selects bank $24
audio_24_5126_Unused_40:
    INCLUDE "data/audio/unused/unused_24_40.asm"               ; entry $40 - unreachable, nothing selects bank $24
audio_24_512a_Unused_41:
    INCLUDE "data/audio/unused/unused_24_41.asm"               ; entry $41 - unreachable, nothing selects bank $24
