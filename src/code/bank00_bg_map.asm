...
; filled. Clears dirty flag, loads HUD tiles, updates map window
    ...
    ld   [wD6FE_BgMap_AltBlocksetMask], A                                    ;; 00:127c $ea $fe $d6
    call call_00_2e9c_MapData_GetTilesetBank                                  ;; 00:127f $cd $9c $2e
    ld   [wD6FF_BgMap_TilesetBank], A                                    ;; 00:1282 $ea $ff $d6
    call call_00_2ea5_MapData_GetTilesetBankOffset                                  ;; 00:1285 $cd $a5 $2e
    ld   HL, wD700_BgMap_TilesetBankOffset                                     ;; 00:1288 $21 $00 $d7
    ld   [HL], E                                       ;; 00:128b $73
    inc  HL                                            ;; 00:128c $23
    ld   [HL], D                                       ;; 00:128d $72
    ...
    xor  A, A                                          ;; 00:1299 $af
    ld   [wD77B_BlockPatch_VramWritePending], A                                    ;; 00:129a $ea $7b $d7
    ld   [wD77D_BlockPatch_StepsRemaining], A                                    ;; 00:129d $ea $7d $d7
...
.jr_00_12a2:
    ...
    ld   [wD6F9_BgMap_LoadingFlags], A                                    ;; 00:12c6 $ea $f9 $d6
    FARCALL call_03_66ae_HUD_LoadTiles
    FARCALL call_02_715a_MapWindow_Update
    xor  A, A                                          ;; 00:12df $af
    ld   [wD6F9_BgMap_LoadingFlags], A                                    ;; 00:12e0 $ea $f9 $d6
    ret                                                ;; 00:12e3 $c9
...
.jr_00_12ea:
    ...
    ld   [wD778_BlockPatch_SlotWriteHead], A                                    ;; 00:12ee $ea $78 $d7
    ld   HL, wD624_CurrentLevelId                                     ;; 00:12f1 $21 $24 $d6
    ld   L, [HL]                                       ;; 00:12f4 $6e
    ld   H, $00                                        ;; 00:12f5 $26 $00
    ld   DE, .data_00_1356_LevelInitialPatchSlots                                     ;; 00:12f7 $11 $56 $13
    add  HL, DE                                        ;; 00:12fa $19
    ld   A, [HL]                                       ;; 00:12fb $7e
    ld   HL, wD798_BlockPatch_SlotTable13                                     ;; 00:12fc $21 $98 $d7
...
.jr_00_1301:
    ...
    and  A, A                                          ;; 00:130b $a7
    ret  NZ                                            ;; 00:130c $c0
    ld   HL, .data_00_1375_MediaDimension_InitialPatches                                     ;; 00:130d $21 $75 $13
.jr_00_1310:
    ld   A, [HL]                                       ;; 00:1310 $7e
    ...
    ld   DE, wD78B_BlockPatch_SlotTable                                     ;; 00:132a $11 $8b $d7
...
.jr_00_1332:
    ...
    inc  HL                                            ;; 00:1333 $23
    ld   A, [HL+]                                      ;; 00:1334 $2a
    ld   [wD782_BlockPatch_TargetBlockX], A                                    ;; 00:1335 $ea $82 $d7
    ld   A, [HL+]                                      ;; 00:1338 $2a
    ld   [wD783_BlockPatch_TargetBlockY], A                                    ;; 00:1339 $ea $83 $d7
    ld   A, L                                          ;; 00:133c $7d
    ld   [wD780_BlockPatch_DataPtrLo], A                                    ;; 00:133d $ea $80 $d7
    ld   A, H                                          ;; 00:1340 $7c
    ld   [wD781_BlockPatch_DataPtrHi], A                                    ;; 00:1341 $ea $81 $d7
    ld   A, $02                                        ;; 00:1344 $3e $02
    ld   [wD784_BlockPatch_Width], A                                    ;; 00:1346 $ea $84 $d7
    ld   [wD785_BlockPatch_Height], A                                    ;; 00:1349 $ea $85 $d7
    call call_00_1ec9_BlockPatch_Register                                  ;; 00:134c $cd $c9 $1e
.jr_00_134f:
    pop  HL                                            ;; 00:134f $e1
...
.jr_00_13cb:
    ld   HL, wD6ED_BgMap_ScrollX                                     ;; 00:13cb $21 $ed $d6
    ld   [HL], E                                       ;; 00:13ce $73
    inc  HL                                            ;; 00:13cf $23
    ld   [HL], D                                       ;; 00:13d0 $72
    ld   L, E                                          ;; 00:13d1 $6b
...
.jr_00_1404:
    ld   HL, wD6EF_BgMap_ScrollY                                     ;; 00:1404 $21 $ef $d6
    ld   [HL], E                                       ;; 00:1407 $73
    inc  HL                                            ;; 00:1408 $23
    ld   [HL], D                                       ;; 00:1409 $72
    ld   L, E                                          ;; 00:140a $6b
...
; and MapTileAnim_Init
    ld   A, [wD6FF_BgMap_TilesetBank]                                    ;; 00:1419 $fa $ff $d6
    call call_00_1089_SwitchBank                                  ;; 00:141c $cd $89 $10
    ld   HL, wD700_BgMap_TilesetBankOffset                                     ;; 00:141f $21 $00 $d7
    ld   A, [HL+]                                      ;; 00:1422 $2a
    ld   H, [HL]                                       ;; 00:1423 $66
    ld   L, A                                          ;; 00:1424 $6f
    ld   DE, VRAM_TILESET_ADDR_1                                     ;; 00:1425 $11 $00 $90
.jr_00_1428:
    ld   A, [HL+]                                      ;; 00:1428 $2a
    ld   [DE], A                                       ;; 00:1429 $12
    inc  DE                                            ;; 00:142a $13
    ...
    ld   DE, VRAM_TILESET_ADDR_2                                     ;; 00:1430 $11 $00 $88
.jr_00_1433:
    ld   A, [HL+]                                      ;; 00:1433 $2a
    ld   [DE], A                                       ;; 00:1434 $12
    inc  DE                                            ;; 00:1435 $13
...
; $20-byte boundaries
    ld   HL, wD6EF_BgMap_ScrollY                                     ;; 00:1472 $21 $ef $d6
    ld   A, [HL+]                                      ;; 00:1475 $2a
    ld   C, A                                          ;; 00:1476 $4f
    ld   A, [HL+]                                      ;; 00:1477 $2a
...
.jr_00_1486:
    ...
    ld   HL, wD6ED_BgMap_ScrollX                      ;; 00:1489 $21 $ed $d6
    ld   A, [HL+]                                      ;; 00:148c $2a
    ld   E, A                                          ;; 00:148d $5f
    ld   A, [HL+]                                      ;; 00:148e $2a
    ld   D, A                                          ;; 00:148f $57 ; after this point DE is equal to [wD6ED_BgMap_ScrollX], BC is [wD6EF_BgMap_ScrollY]
    ld   L, C                                          ;; 00:1490 $69
    ld   H, B                                          ;; 00:1491 $60 ; HL = [wD6EF_BgMap_ScrollY]
    ...
    ld   [DE], A                                       ;; 00:1505 $12 [wD703_BgMap_TempScratchRowAltBlocksetFlags] = a (which is 0)
    inc  DE                                            ;; 00:1506 $13
    ...
    call call_00_18a7_BgMap_ApplyBlockPatchesToRow                                  ;; 00:1520 $cd $a7 $18
    ...
    ld   H, A                                          ;; 00:152f $67
    ld   DE, wD702_BgMap_TempScratchRowMetaTileIDs                                     ;; 00:1530 $11 $02 $d7
...
; boundaries
    ld   HL, wD6ED_BgMap_ScrollX                                     ;; 00:157a $21 $ed $d6
    ld   A, [HL+]                                      ;; 00:157d $2a
    ld   E, A                                          ;; 00:157e $5f
    ld   A, [HL+]                                      ;; 00:157f $2a
    ld   D, A                                          ;; 00:1580 $57
...
.jr_00_158e:
    ...
    ld   E, L                                          ;; 00:158f $5d
    ld   D, H                                          ;; 00:1590 $54
    ld   HL, wD6EF_BgMap_ScrollY                                     ;; 00:1591 $21 $ef $d6
    ld   A, [HL+]                                      ;; 00:1594 $2a
    ld   C, A                                          ;; 00:1595 $4f
    ld   A, [HL+]                                      ;; 00:1596 $2a
    ld   B, A                                          ;; 00:1597 $47
    ...
    call call_00_18e4_BgMap_ApplyBlockPatchesToColumn                                  ;; 00:163a $cd $e4 $18
    ...
    ld   H, A                                          ;; 00:1649 $67
    ld   DE, wD70E_BgMap_TempScratchColumnMetaTileIDs                                     ;; 00:164a $11 $0e $d7
...
; until VBLANK flushes the write. Restores bank
    ld   A, [wD6F7_BgMap_BlocksetAndCollisionBank]                                    ;; 00:169f $fa $f7 $d6
    call call_00_1089_SwitchBank                                  ;; 00:16a2 $cd $89 $10
    ld   HL, wD780_BlockPatch_DataPtrLo                                     ;; 00:16a5 $21 $80 $d7
    ld   E, [HL]                                       ;; 00:16a8 $5e
    inc  HL                                            ;; 00:16a9 $23
    ld   D, [HL]                                       ;; 00:16aa $56
    ld   HL, wD77E_BlockPatch_TilemapAddrLo                                     ;; 00:16ab $21 $7e $d7
    ld   A, [HL+]                                      ;; 00:16ae $2a
    ld   H, [HL]                                       ;; 00:16af $66
    ld   L, A                                          ;; 00:16b0 $6f
    ld   A, [wD785_BlockPatch_Height]                                    ;; 00:16b1 $fa $85 $d7
.jp_00_16b4:
    push AF                                            ;; 00:16b4 $f5
    push HL                                            ;; 00:16b5 $e5
    ld   A, [wD784_BlockPatch_Width]                                    ;; 00:16b6 $fa $84 $d7
.jp_00_16b9:
    push AF                                            ;; 00:16b9 $f5
    push DE                                            ;; 00:16ba $d5
    push HL                                            ;; 00:16bb $e5
...
.jr_00_16cd:
    ...
    ld   HL, wD77B_BlockPatch_VramWritePending                                     ;; 00:1771 $21 $7b $d7
...
; base address from wD77E/wD77F
    ...
    ld   HL, wD77E_BlockPatch_TilemapAddrLo                                     ;; 00:1784 $21 $7e $d7
    ld   A, [HL+]                                      ;; 00:1787 $2a
    ld   H, [HL]                                       ;; 00:1788 $66
    ld   L, A                                          ;; 00:1789 $6f
    ld   B, $cf                                        ;; 00:178a $06 $cf
    ld   A, [wD785_BlockPatch_Height]                                    ;; 00:178c $fa $85 $d7
.jp_00_178f:
    push AF                                            ;; 00:178f $f5
    push HL                                            ;; 00:1790 $e5
    ld   A, [wD784_BlockPatch_Width]                                    ;; 00:1791 $fa $84 $d7
.jp_00_1794:
    push AF                                            ;; 00:1794 $f5
    push HL                                            ;; 00:1795 $e5
    ld   E, L                                          ;; 00:1796 $5d
...
.jp_00_182a:
    ld   HL, wD77E_BlockPatch_TilemapAddrLo                                     ;; 00:182a $21 $7e $d7
    ld   A, [HL+]                                      ;; 00:182d $2a
    ld   H, [HL]                                       ;; 00:182e $66
    ld   L, A                                          ;; 00:182f $6f
    ld   BC, $1d                                       ;; 00:1830 $01 $1d $00
    ld   A, [wD785_BlockPatch_Height]                                    ;; 00:1833 $fa $85 $d7
.jr_00_1836:
    push AF                                            ;; 00:1836 $f5
    push HL                                            ;; 00:1837 $e5
    ld   A, [wD784_BlockPatch_Width]                                    ;; 00:1838 $fa $84 $d7
.jr_00_183b:
    push AF                                            ;; 00:183b $f5
    push HL                                            ;; 00:183c $e5
    ld   E, L                                          ;; 00:183d $5d
...
.jr_00_1959:
    ...
    ld   DE, wCF00_TilesetPaletteIds                                     ;; 00:199f $11 $00 $cf
...
; If bit 0 set, loops back immediately to process the next step without waiting for the next frame
    ld   HL, wD786_BlockPatch_StepTimer                                     ;; 00:1e5b $21 $86 $d7
    ld   A, [HL]                                       ;; 00:1e5e $7e
    and  A, A                                          ;; 00:1e5f $a7
    jr   Z, .jr_00_1e63                                ;; 00:1e60 $28 $01
    dec  [HL]                                          ;; 00:1e62 $35
.jr_00_1e63:
    ld   A, [wD77B_BlockPatch_VramWritePending]                                    ;; 00:1e63 $fa $7b $d7
    and  A, A                                          ;; 00:1e66 $a7
    ret  NZ                                            ;; 00:1e67 $c0
    ld   A, [HL]                                       ;; 00:1e68 $7e
    and  A, A                                          ;; 00:1e69 $a7
    ret  NZ                                            ;; 00:1e6a $c0
    ld   A, [wD787_BlockPatch_StepTimerReload]                                    ;; 00:1e6b $fa $87 $d7
    ld   [HL], A                                       ;; 00:1e6e $77
.jr_00_1e6f:
    ld   HL, wD77D_BlockPatch_StepsRemaining                                     ;; 00:1e6f $21 $7d $d7
    ld   A, [HL]                                       ;; 00:1e72 $7e
    and  A, A                                          ;; 00:1e73 $a7
    ret  Z                                             ;; 00:1e74 $c8
    dec  [HL]                                          ;; 00:1e75 $35
    ld   HL, wD780_BlockPatch_DataPtrLo                                     ;; 00:1e76 $21 $80 $d7
    ld   A, [HL+]                                      ;; 00:1e79 $2a
    ld   H, [HL]                                       ;; 00:1e7a $66
    ld   L, A                                          ;; 00:1e7b $6f
    ld   A, [HL+]                                      ;; 00:1e7c $2a
    ld   [wD77C_BlockPatch_StepFlags], A                                    ;; 00:1e7d $ea $7c $d7
    bit  BLOCKPATCH_STEP_SFX_BIT, A                      ;; 00:1e80 $cb $6f
...
.jr_00_1e8a:
    ld   A, L                                          ;; 00:1e8a $7d
    ld   [wD780_BlockPatch_DataPtrLo], A                                    ;; 00:1e8b $ea $80 $d7
    ld   A, H                                          ;; 00:1e8e $7c
    ld   [wD781_BlockPatch_DataPtrHi], A                                    ;; 00:1e8f $ea $81 $d7
    ld   HL, wD77C_BlockPatch_StepFlags                                     ;; 00:1e92 $21 $7c $d7
    bit  BLOCKPATCH_STEP_REGISTER_BIT, [HL]              ;; 00:1e95 $cb $4e
    call NZ, call_00_1ec9_BlockPatch_Register                              ;; 00:1e97 $c4 $c9 $1e
    ld   HL, wD77C_BlockPatch_StepFlags                                     ;; 00:1e9a $21 $7c $d7
    bit  BLOCKPATCH_STEP_COLLISION_BIT, [HL]             ;; 00:1e9d $cb $56
    call NZ, call_00_1f05_BlockPatch_WriteCollision                              ;; 00:1e9f $c4 $05 $1f
    ld   HL, wD77C_BlockPatch_StepFlags                                     ;; 00:1ea2 $21 $7c $d7
    bit  BLOCKPATCH_STEP_TILES_BIT, [HL]                 ;; 00:1ea5 $cb $5e
    call NZ, call_00_169f_BlockPatch_WriteTiles                              ;; 00:1ea7 $c4 $9f $16
    ld   HL, wD785_BlockPatch_Height                                     ;; 00:1eaa $21 $85 $d7
    ld   B, [HL]                                       ;; 00:1ead $46
    ld   HL, wD784_BlockPatch_Width                                     ;; 00:1eae $21 $84 $d7
    ld   C, [HL]                                       ;; 00:1eb1 $4e
    xor  A, A                                          ;; 00:1eb2 $af
.jr_00_1eb3:
    add  A, C                                          ;; 00:1eb3 $81
    ...
    add  A, A                                          ;; 00:1eb7 $87
    ld   HL, wD780_BlockPatch_DataPtrLo                                     ;; 00:1eb8 $21 $80 $d7
    add  A, [HL]                                       ;; 00:1ebb $86
    ld   [HL+], A                                      ;; 00:1ebc $22
    ld   A, $00                                        ;; 00:1ebd $3e $00
    adc  A, [HL]                                       ;; 00:1ebf $8e
    ld   [HL], A                                       ;; 00:1ec0 $77
    ld   HL, wD77C_BlockPatch_StepFlags                                     ;; 00:1ec1 $21 $7c $d7
    bit  BLOCKPATCH_STEP_LOOP_BIT, [HL]                  ;; 00:1ec4 $cb $46
...
; step only - the intermediate animation frames are not meant to survive
    ld   HL, wD782_BlockPatch_TargetBlockX                                     ;; 00:1ec9 $21 $82 $d7
    ld   C, [HL]                                       ;; 00:1ecc $4e
    ld   HL, wD783_BlockPatch_TargetBlockY                                     ;; 00:1ecd $21 $83 $d7
    ld   B, [HL]                                       ;; 00:1ed0 $46
    ld   HL, wD780_BlockPatch_DataPtrLo                                     ;; 00:1ed1 $21 $80 $d7
    ld   E, [HL]                                       ;; 00:1ed4 $5e
    inc  HL                                            ;; 00:1ed5 $23
    ld   D, [HL]                                       ;; 00:1ed6 $56
    ld   HL, wD778_BlockPatch_SlotWriteHead                                     ;; 00:1ed7 $21 $78 $d7
    ld   L, [HL]                                       ;; 00:1eda $6e
    ld   H, $ce                                        ;; 00:1edb $26 $ce
    ld   A, [wD785_BlockPatch_Height]                                    ;; 00:1edd $fa $85 $d7
.jr_00_1ee0:
    push AF                                            ;; 00:1ee0 $f5
    push BC                                            ;; 00:1ee1 $c5
    ld   A, [wD784_BlockPatch_Width]                                    ;; 00:1ee2 $fa $84 $d7
.jr_00_1ee5:
    push AF                                            ;; 00:1ee5 $f5
    ...
    ld   A, L                                          ;; 00:1f00 $7d
    ld   [wD778_BlockPatch_SlotWriteHead], A                                    ;; 00:1f01 $ea $78 $d7
    ret                                                ;; 00:1f04 $c9
...
; from wD780/wD781 data pointer into the matched slot range in `$CE[slot
    ld   HL, wD782_BlockPatch_TargetBlockX                                     ;; 00:1f05 $21 $82 $d7
    ld   C, [HL]                                       ;; 00:1f08 $4e
    ld   HL, wD783_BlockPatch_TargetBlockY                                     ;; 00:1f09 $21 $83 $d7
    ld   B, [HL]                                       ;; 00:1f0c $46
    ld   HL, wD780_BlockPatch_DataPtrLo                                     ;; 00:1f0d $21 $80 $d7
    ld   E, [HL]                                       ;; 00:1f10 $5e
    inc  HL                                            ;; 00:1f11 $23
    ld   D, [HL]                                       ;; 00:1f12 $56
    ld   HL, wD778_BlockPatch_SlotWriteHead                                     ;; 00:1f13 $21 $78 $d7
    ld   L, [HL]                                       ;; 00:1f16 $6e
    dec  L                                             ;; 00:1f17 $2d
...
.jr_00_1f2a:
    ...
    ld   A, [wD785_BlockPatch_Height]                                    ;; 00:1f2e $fa $85 $d7
    ld   B, A                                          ;; 00:1f31 $47
.jr_00_1f32:
    ld   A, [wD784_BlockPatch_Width]                                    ;; 00:1f32 $fa $84 $d7
    ld   C, A                                          ;; 00:1f35 $4f
.jr_00_1f36:
    ld   A, [DE]                                       ;; 00:1f36 $1a
    ld   [HL], A                                       ;; 00:1f37 $77
