; bank $24: entry $26 - unreachable, nothing selects bank $24
; bank $24: entry $2C - unreachable, nothing selects bank $24
;
; One driver track for hardware channel 1 (pulse A), 46 bytes, 12 notes, ending in
; AUDIO_CMD_END.
;
