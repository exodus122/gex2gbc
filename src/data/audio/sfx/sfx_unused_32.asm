; banks $21, $22, $23: driver sfx id $32 - no .data_00_116c_SFXChannelTable row reaches it
;
; One driver track for hardware channel 4 (noise), 12 bytes, 2 notes, ending in
; AUDIO_CMD_END.
;
