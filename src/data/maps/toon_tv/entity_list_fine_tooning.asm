    ...
    db   ENTITY_TOON_TV_MOVING_BLOCK
    dw   $01b0, $08c8
    db   $10, $0a, $47
    ...
    db   ENTITY_TOON_TV_VANISHING_BLOCK
    dw   $0290, $0930
    db   $19, $13, $4c
    ...
    db   ENTITY_TOON_TV_STATIONARY_BEAR_TRAP
    dw   $0880, $0ed8
    db   $45, $43, $77
    ...
    db   ENTITY_TOON_TV_MOVING_BEAR_TRAP
    dw   $0bd0, $0f30
    db   $60, $5c, $7a
