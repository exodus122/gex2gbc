...
;
; Rendered from data/maps/toon_tv/doors_out_of_toon.bin
...
; ==================================================================
    ...
    db   $41, $03, $03, $28                    ; #$00  <-> #$03
    db   $6a, $1d, $03, $3c                    ; #$01  <-> #$04
    db   $49, $36, $52, $3e                    ; #$02  one-way
    db   $03, $28, $41, $03                    ; #$03  <-> #$00
    db   $03, $3c, $6a, $1d                    ; #$04  <-> #$01
    db   SPAWN_LIST_END
