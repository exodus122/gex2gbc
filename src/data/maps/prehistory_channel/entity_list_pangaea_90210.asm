    ...
    db   ENTITY_PRE_HISTORY_FALLING_BOULDER
    dw   $05a0, $0230
    db   $31, $28, $12
    ...
    db   ENTITY_PRE_HISTORY_DRAGONFLY
    dw   $0110, $0270
    db   $09, $04, $14
    ...
    db   ENTITY_PRE_HISTORY_TRICERATOPS
    dw   $08d0, $05b0
    db   $49, $44, $2e
    ...
    db   ENTITY_PRE_HISTORY_DINOSAUR
    dw   $07d0, $0810
    db   $40, $3c, $41
    ...
    db   ENTITY_PRE_HISTORY_FAST_DINOSAUR
    dw   $0290, $08d0
    db   $17, $0f, $47
