...
map_circuit_central3:
    INCBIN "data/maps/circuit_central/map_circuit_central3.bin"
...
blockset_data_channel_z:
    INCBIN "data/maps/channel_z/blockset_data_channel_z.bin"

SECTION "bank28", ROMX[$4000], BANK[$28]
map_channel_z:
    INCBIN "data/maps/channel_z/map_channel_z.bin"

SECTION "bank29", ROMX[$4000], BANK[$29]
map_rezopolis:
    INCBIN "data/maps/rezopolis/map_rezopolis.bin"

SECTION "bank2a", ROMX[$4000], BANK[$2a]
map_circuit_central1:
    INCBIN "data/maps/circuit_central/map_circuit_central1.bin"

SECTION "bank2b", ROMX[$4000], BANK[$2b]
map_circuit_central2:
    INCBIN "data/maps/circuit_central/map_circuit_central2.bin"

SECTION "bank2c", ROMX[$4000], BANK[$2c]
map_kung_fu_theater1:
    INCBIN "data/maps/kung_fu_theater/map_kung_fu_theater1.bin"

SECTION "bank2d", ROMX[$4000], BANK[$2d]
map_kung_fu_theater2:
    INCBIN "data/maps/kung_fu_theater/map_kung_fu_theater2.bin"

SECTION "bank2e", ROMX[$4000], BANK[$2e]
map_prehistory_channel1:
    INCBIN "data/maps/prehistory_channel/map_prehistory_channel1.bin"

SECTION "bank2f", ROMX[$4000], BANK[$2f]
map_prehistory_channel2:
    INCBIN "data/maps/prehistory_channel/map_prehistory_channel2.bin"

SECTION "bank30", ROMX[$4000], BANK[$30]
map_media_dimension:
    INCBIN "data/maps/media_dimension/map_media_dimension.bin"

SECTION "bank31", ROMX[$4000], BANK[$31]
map_toon_tv:
    INCBIN "data/maps/toon_tv/map_toon_tv.bin"

SECTION "bank32", ROMX[$4000], BANK[$32]
map_scream_tv1:
    INCBIN "data/maps/scream_tv/map_scream_tv1.bin"
...
blockset_data_media_dimension:
    INCBIN "data/maps/media_dimension/blockset_data_media_dimension.bin"

SECTION "bank39", ROMX[$4000], BANK[$39]
blockset_data_toon_tv:
    INCBIN "data/maps/toon_tv/blockset_data_toon_tv.bin"

SECTION "bank3A", ROMX[$4000], BANK[$3a]
blockset_data_scream_tv:
    INCBIN "data/maps/scream_tv/blockset_data_scream_tv.bin"

SECTION "bank3B", ROMX[$4000], BANK[$3b]
blockset_data_circuit_central:
    INCBIN "data/maps/circuit_central/blockset_data_circuit_central.bin"

SECTION "bank3C", ROMX[$4000], BANK[$3c]
blockset_data_kung_fu_theater:
    INCBIN "data/maps/kung_fu_theater/blockset_data_kung_fu_theater.bin"
...
blockset_data_prehistory_channel:
    INCBIN "data/maps/prehistory_channel/blockset_data_prehistory_channel.bin"

SECTION "bank3F", ROMX[$4000], BANK[$3f]
blockset_data_rezopolis:
    INCBIN "data/maps/rezopolis/blockset_data_rezopolis.bin"
